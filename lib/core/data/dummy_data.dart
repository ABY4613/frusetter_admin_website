...
class DummyData {
  ...
  static final List<FeedbackItem> feedbackList = [
    FeedbackItem(
      ...
      deliveryRating: 5,
      feedbackType: 'food',
      comments: 'The food is absolutely amazing! Fresh and healthy.',
    ...
    FeedbackItem(
      ...
      comments: 'Delivery was a bit late, but the food is good.',
    ...
    FeedbackItem(
      ...
      planName: 'Standard Meal Plan',
      rating: 4,
      foodQualityRating: 4,
      deliveryRating: 4,
      feedbackType: 'general',
      comments: 'Great variety of meals.',
